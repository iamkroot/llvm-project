...
define dso_local noundef i8* @_Znamc(i64 noundef %0, i8 noundef signext %1) #0 {
...
define dso_local noundef i32 @main(i32 noundef %0, i8** noundef %1) #1 {
  ...
  %13 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %9, i8* noundef %12)
  %14 = call noundef i8* @_Znamc(i64 noundef 400, i8 noundef signext 99)
