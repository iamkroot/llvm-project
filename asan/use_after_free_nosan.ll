...
define dso_local noundef i8* @_ZnamPKc(i64 noundef %0, i8* noundef %1) #0 {
  %3 = alloca i64, align 8
  %4 = alloca i8*, align 8
  store i64 %0, i64* %3, align 8
  store i8* %1, i8** %4, align 8
  %5 = load i8*, i8** %4, align 8
  %6 = call i32 (i8*, ...) @printf(i8* noundef %5)
...
define dso_local noundef i32 @main(i32 noundef %0, i8** noundef %1) #2 {
  ...
  %14 = call noundef i8* @_ZnamPKc(i64 noundef 400, i8* noundef %13)
