...
define dso_local noundef i32 @main(i32 noundef %argc, i8** noundef %argv) #0 !dbg !207 {
entry:
  ...
  %0 = load i8**, i8*** %argv.addr, align 8, !dbg !216
  %arrayidx = getelementptr inbounds i8*, i8** %0, i64 1, !dbg !216
  %1 = ptrtoint i8** %arrayidx to i64, !dbg !216
  %2 = lshr i64 %1, 3, !dbg !216
  %3 = add i64 %2, 2147450880, !dbg !216
  %4 = inttoptr i64 %3 to i8*, !dbg !216
  %5 = load i8, i8* %4, align 1, !dbg !216
  %6 = icmp ne i8 %5, 0, !dbg !216
  br i1 %6, label %7, label %8, !dbg !216

7:                                                ; preds = %entry
  call void @__asan_report_load8(i64 %1) #5, !dbg !216
  unreachable, !dbg !216

8:                                                ; preds = %entry
  %9 = load i8*, i8** %arrayidx, align 8, !dbg !216
  %call = call i32 (i8*, ...) @printf(i8* noundef %9), !dbg !217
  %10 = load i8**, i8*** %argv.addr, align 8, !dbg !218
  %arrayidx1 = getelementptr inbounds i8*, i8** %10, i64 1, !dbg !218
  %11 = ptrtoint i8** %arrayidx1 to i64, !dbg !218
  %12 = lshr i64 %11, 3, !dbg !218
  %13 = add i64 %12, 2147450880, !dbg !218
  %14 = inttoptr i64 %13 to i8*, !dbg !218
  %15 = load i8, i8* %14, align 1, !dbg !218
  %16 = icmp ne i8 %15, 0, !dbg !218
  br i1 %16, label %17, label %18, !dbg !218

17:                                               ; preds = %8
  call void @__asan_report_load8(i64 %11) #5, !dbg !218
  unreachable, !dbg !218

18:                                               ; preds = %8
  %19 = load i8*, i8** %arrayidx1, align 8, !dbg !218
  %arrayidx2 = getelementptr inbounds i8, i8* %19, i64 1, !dbg !218
  %20 = ptrtoint i8* %arrayidx2 to i64, !dbg !218
  ...
  br i1 %25, label %26, label %31, !dbg !218, !prof !219

26:                                               ; preds = %18
  %27 = and i64 %20, 7, !dbg !218
  %28 = trunc i64 %27 to i8, !dbg !218
  %29 = icmp sge i8 %28, %24, !dbg !218
  br i1 %29, label %30, label %31, !dbg !218

30:                                               ; preds = %26
  call void @__asan_report_load1(i64 %20) #5, !dbg !218
  unreachable

31:                                               ; preds = %26, %18
  %32 = load i8, i8* %arrayidx2, align 1, !dbg !218
  %conv = sext i8 %32 to i32, !dbg !218
...
declare i1 @llvm.amdgcn.is.shared(i8* nocapture) #3

; Function Attrs: nounwind readnone speculatable willreturn
declare i1 @llvm.amdgcn.is.private(i8* nocapture) #3
