; ModuleID = 'use_after_free_nosan.dbg.ll'
...
define dso_local noundef i32 @main(i32 noundef %0, i8** noundef %1) #3 !dbg !219 {
  ...
  %9 = ptrtoint i8** %8 to i64, !dbg !227
  %10 = lshr i64 %9, 3, !dbg !227
  %11 = add i64 %10, 2147450880, !dbg !227
  %12 = inttoptr i64 %11 to i8*, !dbg !227
  %13 = load i8, i8* %12, align 1, !dbg !227
  %14 = icmp ne i8 %13, 0, !dbg !227
  br i1 %14, label %15, label %16, !dbg !227

15:                                               ; preds = %2
  call void @__asan_report_load8(i64 %9) #6, !dbg !227
  unreachable, !dbg !227

16:                                               ; preds = %2
  %17 = load i8*, i8** %8, align 8, !dbg !227
  %18 = call i32 (i8*, ...) @printf(i8* noundef %17), !dbg !228
  call void @llvm.dbg.declare(metadata i32** %6, metadata !229, metadata !DIExpression()), !dbg !231
  %19 = load i8**, i8*** %5, align 8, !dbg !232
  %20 = getelementptr inbounds i8*, i8** %19, i64 1, !dbg !232
  %21 = ptrtoint i8** %20 to i64, !dbg !232
  %22 = lshr i64 %21, 3, !dbg !232
  %23 = add i64 %22, 2147450880, !dbg !232
  %24 = inttoptr i64 %23 to i8*, !dbg !232
  %25 = load i8, i8* %24, align 1, !dbg !232
  %26 = icmp ne i8 %25, 0, !dbg !232
  br i1 %26, label %27, label %28, !dbg !232

27:                                               ; preds = %16
  call void @__asan_report_load8(i64 %21) #6, !dbg !232
  unreachable, !dbg !232

28:                                               ; preds = %16
  %29 = load i8*, i8** %20, align 8, !dbg !232
  %30 = call noundef i8* @_ZnamPKc(i64 noundef 400, i8* noundef %29), !dbg !233, !heapallocsite !27
  %31 = bitcast i8* %30 to i32*, !dbg !233
  store i32* %31, i32** %6, align 8, !dbg !231
  %32 = load i32*, i32** %6, align 8, !dbg !234
  %33 = getelementptr inbounds i32, i32* %32, i64 5, !dbg !234
  %34 = ptrtoint i32* %33 to i64, !dbg !234
  %35 = lshr i64 %34, 3, !dbg !234
  %36 = add i64 %35, 2147450880, !dbg !234
  %37 = inttoptr i64 %36 to i8*, !dbg !234
  %38 = load i8, i8* %37, align 1, !dbg !234
  %39 = icmp ne i8 %38, 0, !dbg !234
  br i1 %39, label %40, label %46, !dbg !234, !prof !235

40:                                               ; preds = %28
  %41 = and i64 %34, 7, !dbg !234
  %42 = add i64 %41, 3, !dbg !234
  %43 = trunc i64 %42 to i8, !dbg !234
  %44 = icmp sge i8 %43, %38, !dbg !234
  br i1 %44, label %45, label %46, !dbg !234

45:                                               ; preds = %40
  call void @__asan_report_load4(i64 %34) #6, !dbg !234
  unreachable

46:                                               ; preds = %40, %28
  %47 = load i32, i32* %33, align 4, !dbg !234
  ret i32 %47, !dbg !236
}
...
declare i1 @llvm.amdgcn.is.shared(i8* nocapture %0) #4

; Function Attrs: nounwind readnone speculatable willreturn
declare i1 @llvm.amdgcn.is.private(i8* nocapture %0) #4
...
attributes #3 = { mustprogress noinline norecurse optnone sanitize_address uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!235 = !{!"branch_weights", i32 1, i32 100000}
!236 = !DILocation(line: 14, column: 5, scope: !219)
