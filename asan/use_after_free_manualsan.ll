...
; Function Attrs: mustprogress noinline nounwind optnone sanitize_address uwtable
...
declare dso_local i32 @fprintf(%struct._IO_FILE* noundef %0, i8* noundef %1, ...) #3

attributes #0 = { mustprogress noinline nounwind optnone sanitize_address uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
